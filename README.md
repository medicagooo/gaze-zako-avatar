...
- Twelve hairstyles, eight ear choices, twenty hair accessories, ten facewear choices, eleven mouth choices and ten pupil styles; counts include none where applicable. Eight backgrounds. Skin presets display the current avatar in seven tones, with a custom picker.
- Initial/reset avatar reproduces the supplied `gaze-zako-avatar-1789869462537.svg`: crystal ensemble, blue hair, slit pupils, smile and transgender flag. It remains fully editable. Existing gallery presets retain their original expressions and backgrounds.
